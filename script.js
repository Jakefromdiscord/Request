...
const repeatMyParam = () => {
    axios
        .get('http://localhost:3000/repeat/jake')
        .then(res => {

            let el = document.getElementById('repeat-text');
...
const p8 = ()=> {
    axios
        .get('http://localhost:3000/query-test?name=jacob')
        .then(res => {
...
document.getElementById('query-button').addEventListener('click', p8)
